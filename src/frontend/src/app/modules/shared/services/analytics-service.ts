...
export class AnalyticsService {
  ...
  injectFullStoryScript(userId: string): Promise<void> {
    const fullStoryOrganisationId = this.appConfigService.configuration.fullStoryOrganisationId;

    return this.scriptInjectorService.load([
      { name: 'id', value: 'fullStory' },
      { name: 'type', value: 'text/javascript' },
      {
        ...
        value: `
                  ...
                  window['_fs_org'] = '${fullStoryOrganisationId}';
